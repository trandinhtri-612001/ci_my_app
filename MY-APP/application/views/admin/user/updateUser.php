...
<body>
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
            <li><a href="<?=base_url()  ?>productController/viewProduct">
                ...
                <li><a href="#">
                    ...
                    <span class="link-name">Update product</span>
                </a></li>
                <li><a href="#">
  ...
  <form action="<?= base_url()?>userController/updateUserById" method="post">
            ...
            <li>
                ...
                <li>
                    ...
                    <br>
                    <input type="text " value="<?= $value['username']   ?>" placeholder="username" name="username" id="username">
                </li>
                <li>
                    <label for="email">email</label>
                    <br>
                    <input type="email " value="<?= $value['email']   ?>" placeholder="email" name="email" id="email">
                </li>
                <li>
                    <label for="phone">phone</label>
                    <br>
                    <input type="text" value="<?= $value['phone']   ?>" placeholder="phone" name="phone" id="phone">
                </li>
                <li>
                    <label for="date">date</label>
                    <br>
                    <input type="date" value="<?= $value['date']   ?>" placeholder="date" name="date" id="date">
                </li>
                <li>
